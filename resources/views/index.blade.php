...
<header class="navbar navbar-dark sticky-top bg-white flex-md-nowrap p-0 shadow">
    ...
    <img src="{{asset('img')}}/new-logo-white.png" alt="Logo"
         class="bi me-2 " style=" height: calc(calc(4.5rem + 3px) * .6);
...
<div class="container">
    <section class=" d-flex p-2 bd-highlight" >
            ...
            <div class="card text-dark bg-success mb-3" style="max-width: 18rem;">
                ...
                <a href="/products-list" class="btn "
                     class="fa-solid fa-bars"></i> Products </a>
                </div>
            </div>
            <div class="card text-dark bg-light mb-3" style="max-width: 18rem;">
                <div class="card-body">
                    <a href="/makeInvoice" class="btn "
                    class="fa-solid fa-bars"></i> POS</a>
                </div>
            </div>
            <div class="card text-dark bg-info mb-3" style="max-width: 18rem;">
                <div class="card-body">
                    <a href="/invoices-list" class="btn "
                    class="fa-solid fa-bars"></i> Invoices </a>
                </div>
            </div>  
    </section>
    </div>
